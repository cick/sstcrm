        ...
        methods: {
                ...
                customFieldList(params)
                    .then(res => {
                        for (let index = 0; index < res.data.length; index++) {
                            ...
                            element.is_automatic_number = element.is_automatic_number == 1
                        }
            ...
            handleSave() {
                ...
                for (let index = 0; index < tempFieldArr.length; index++) {
                    ...
                    item.is_automatic_number = item.is_automatic_number == true ? 1 : 0
                    ...
                    if (item.form_type == 'form') {
                        for (
                            ...
                            tableItem.is_automatic_number = tableItem.is_automatic_number == true ? 1 : 0

<template>
  <div class="field-info-section">
    ...
    <div v-if="show_automatic_number" class="item-section">
      <div class="item-check-section">
        <el-checkbox v-model="field.is_automatic_number" :disabled="disabled">是否自动获取编码</el-checkbox>
      </div>
    </div>
    <div class="item-check-section">
      <el-checkbox
...
<script type="text/javascript">
    ...
    export default {
            ...
            field: {
                ...
                default: () => {
                    return {
                        ...
                        is_null: false, // 是否必填
                        is_automatic_number: false, //是否自动获取编码
                        input_tips: '', // 输入提示
        ...
        computed: {
            ...
            /** 展示是否自动获取编码 */
            show_automatic_number() {
                if (this.field.form_type == 'text') {
                    return true
                }
                return false
            },
